...
//   val MEM_NUM_LINES = 1024
   val MEM_NUM_LINES = 16
   ...
   val OP1_LUI = UFix(1, 1); // Load Upper Immediate
   val OP1_X   = UFix(0, 1);
   ...
   val OP2_12  = UFix(3, 2); // literal 12 (for LUI shift)
   val OP2_X   = UFix(0, 2);
