...
disassembler::disassembler()
{
  ...
  // software compiler generated NOP instruction (ADDi, x0, x0, 0)
  DEFINE_NOARG(nop);
  // hardware inserted bubble/NOP instruction (XOR, x0, x0, x0)
  add_insn(new disasm_insn_t(" -", match_bubble, mask_bubble));
